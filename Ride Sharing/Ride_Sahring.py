...
pathao_company = Ride_Sharing('Niye Jao')
sakib = Rider("sakib Khan", 'sakib@khan.com', 1254, 'mohakhali', 1200)
pathao_company.add_rider(sakib)
kala_pakhi = Driver('Kala Pakhi', 'kala@sada.com', 5648, 'gulshan 1')
pathao_company.add_driver(kala_pakhi)
print(pathao_company)
sakib.request_ride(pathao_company, 'uttara')
